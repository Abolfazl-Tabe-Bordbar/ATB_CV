  ...
  >
    <v-card-text>
      ...
      <div class="text-sm-center mb-4 mt-3">
        <h1>
          Abolfazl <span class="light-blue--text text--lighten-3">Tabe Bordbar</span>
        </h1>
        <span>
          A web developer
        </span>
          ...
          items: [
            {
              name: 'Email',
              icon: 'mdi-email',
              text: 'abolfazl.tabe95@gmail.com',
            },
            {
              name: 'Birth Date',
          ...
          items: [
            {
              ...
              text: 'github.com/Abolfazl-Tabe-Bordbar',
              link: 'https://github.com/Abolfazl-Tabe-Bordbar',
            },
            {
              icon: 'mdi-instagram',
              text: 'instagram.com/abolfazl_tabe_bordbar',
              link: 'https://instagram.com/abolfazl_tabe_bordbar',
            },
          ],
        },
        languages: {
